# MagCluster: a tool for identification, annotation and visualization of magnetosome gene clusters (MGCs)
[![Anaconda-Server Badge](https://anaconda.org/bioconda/magcluster/badges/version.svg)](https://anaconda.org/bioconda/magcluster) [![Conda](https://img.shields.io/conda/dn/bioconda/magcluster?logo=anaconda&style=flat-square)](https://anaconda.org/bioconda/magcluster) [![PyPI](https://img.shields.io/pypi/v/magcluster?style=flat-square)](https://pypi.org/project/magcluster/) [![PyPI - Downloads](https://img.shields.io/pypi/dm/magcluster?logo=pypi&style=flat-square)](https://pypi.org/project/magcluster/)
[![Anaconda-Server Badge](https://anaconda.org/bioconda/magcluster/badges/installer/conda.svg)](https://conda.anaconda.org/bioconda) [![Anaconda-Server Badge](https://anaconda.org/bioconda/magcluster/badges/latest_release_date.svg)](https://anaconda.org/bioconda/magcluster) [![Anaconda-Server Badge](https://anaconda.org/bioconda/magcluster/badges/license.svg)](https://anaconda.org/bioconda/magcluster) 

MagCluster leverages the physical cluster property of magnetosome genes on the chromosome to identify MGCs, which are otherwise difficult to accurately identify based solely on sequence identity.
